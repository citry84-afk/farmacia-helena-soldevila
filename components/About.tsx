...
/** Foto de Helena y texto de presentación (bloque superior de la página). */
  ...
  return (
    <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
      ...
      <ScrollReveal delay={100}>
        <div
          id="about-heading"
          className="space-y-6 text-lg leading-relaxed text-graphite/75 md:text-xl md:leading-relaxed"
        >
          <p>
            Hola, soy Helena, farmacéutica titular desde 2022. Desde siempre tuve claro que quería
            dedicarme a la oficina de farmacia, porque disfruto del trato cercano con las personas
            y de poder ayudar a cada paciente de forma directa.
          </p>
          <p>
